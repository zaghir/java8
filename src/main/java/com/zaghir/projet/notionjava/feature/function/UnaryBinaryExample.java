...
public class UnaryBinaryExample {
	...
	public static void main(String[] args) {
		...
		System.out.println("Result : "+uo1.apply("java8"));
		System.out.println("Result : "+uo2.apply(20));
		
		BinaryOperator<Integer> bo1 = BinaryOperator
				.maxBy((a,b) -> (a > b) ? 1 :(a==b)?0:-1);
		
		System.out.println("Binary Operator MaxBy Result 1 : "+bo1.apply(12, 15));
		
		BinaryOperator<Integer> bo2 = BinaryOperator.maxBy(comp) ;
		System.out.println("Binary Operator MaxBy Result 2 : "+bo2.apply(12, 15));
		
		BinaryOperator<Integer> bo3 = BinaryOperator.minBy(comp) ;
		System.out.println("Binary Operator MinBy Result 3 : "+bo2.apply(12, 15));
	}
}
