...
public class RefMethodeClasse {
	public static void main(String args[]){
		...
		Distanciable dist1 = Point::distance1 ;  // apple à la reference de la methode de la classe comme interface fonctionnel
		System.out.println("dist1 entre p1 et p2 = "+dist1.distance(p1, p2));
		Distanciable dist2 = Point::distance2 ;  // apple à la reference de la methode de la classe comme interface fonctionnel
